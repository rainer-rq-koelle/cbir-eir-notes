...
+-----+----------+-----------------------+-----------------------------+
| Cl  | Flight   | Aircraft Requirements | Minimum Services by ATC     |
| ass | Rules    |                       | Unit                        |
+=====+==========+=======================+=============================+
| A   | IFR only | -   ATC clearance     | separate all aircraft from  |
|     |          |     before entry      | each other                  |
|     |          |                       |                             |
|     |          | -   comply with ATC   |                             |
|     |          |     instructions      |                             |
+-----+----------+-----------------------+-----------------------------+
| B   | IFR and  | -   ATC clearance     | separate all aircraft from  |
|     | VFR      |     before entry      | each other                  |
|     |          |                       |                             |
|     |          | -   comply with ATC   |                             |
|     |          |     instructions      |                             |
+-----+----------+-----------------------+-----------------------------+
| C   | IFR and  | -   ATC clearance     | -   separate IFR from other |
|     | VFR      |     before entry      |     IFR and VFR             |
|     |          |                       |                             |
|     |          | -   comply with ATC   | -   separate VFR from IFR   |
|     |          |     instructions      |                             |
|     |          |                       | -   pass traffic info to    |
|     |          |                       |     VFR on other VFR and    |
|     |          |                       |     give traffic avoidance  |
|     |          |                       |     advice, if requested    |
+-----+----------+-----------------------+-----------------------------+
| D   | IFR and  | -   ATC clearance     | -   separate IFR from IFR   |
|     | VFR      |     before entry      |                             |
|     |          |                       | -   pass traffic info to    |
|     |          | -   comply with ATC   |     IFR on VFR and give     |
|     |          |     instructions      |     traffic avoidance       |
|     |          |                       |     advice, if requested    |
|     |          |                       |                             |
|     |          |                       | -   pass traffic info to    |
|     |          |                       |     VFR on IFR and other    |
|     |          |                       |     VFR flights             |
+-----+----------+-----------------------+-----------------------------+
| E   | IFR and  | -   IFR flights       | -   separate IFR from IFR   |
|     | VFR      |     clearance before  |                             |
|     |          |     entry and comply  | -   pass traffic info as    |
|     |          |     with ATC          |     far as practicable to   |
|     |          |     instructions      |     IFR on VFR              |
|     |          |                       |                             |
|     |          | -   VFR flights do    | -   VFR flights in contact: |
|     |          |     not require       |     traffic info as far as  |
|     |          |     clearance         |     practicable             |
+-----+----------+-----------------------+-----------------------------+
| F   | IFR and  | participating IFR     | separate participating IFR  |
|     | VFR      | flights are expected  | lights from each other      |
|     |          | to comply with ATC    |                             |
|     |          | instructions          |                             |
+-----+----------+-----------------------+-----------------------------+
| G   | IFR and  | non                   | none                        |
